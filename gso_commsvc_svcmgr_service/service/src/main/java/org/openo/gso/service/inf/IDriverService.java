...
public interface IDriverService {
     ...
     * @throws ServiceException when fail to delete the sub-service
     * @since  GSO 0.5
     */
    String delete(String nodeType, String instanceId) throws ServiceException;
     ...
     * @throws ServiceException when fail to creat the network service
     * @since  GSO 0.5
     */
    String createNS(String templateId, Map<String, String> paramMap) throws ServiceException;
     ...
     * @throws ServiceException when fail to instantiate
     * @since  GSO 0.5
     */
    String instantiateNS(String instanceId, Map<String, String> mapParams) throws ServiceException;
     ...
     * @throws ServiceException when fail to query the progress
     * @since  GSO 0.5
     */
    NsProgressStatus getNsProgress(String jobId) throws ServiceException;
