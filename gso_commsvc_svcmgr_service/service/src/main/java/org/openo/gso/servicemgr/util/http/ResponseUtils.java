...
package org.openo.gso.servicemgr.util.http;
...
public class ResponseUtils {
     ...
     * @since GSO 0.5
     */
    public static Map<String, Object> setResult(ServiceModel model, Object operateCode) {
        Map<String, Object> result = new HashMap<String, Object>();
        result.put(Constant.RESPONSE_RESULT, operateCode);
        String serviceId = (null != model) ? model.getServiceId() : null;
