 ...
 */
drop table gso_lcm_servicebaseinfo if exists;
...
drop table gso_lcm_defPackage_mapping if exists;
...
drop table gso_lcm_inputParam_mapping if exists;
...
(
	...
	constraint gso_f_inputParam_mapping foreign key(serviceId) references gso_lcm_servicebaseinfo (serviceId)
);